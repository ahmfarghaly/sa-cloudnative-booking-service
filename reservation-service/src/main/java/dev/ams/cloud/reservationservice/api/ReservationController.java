package dev.ams.cloud.reservationservice.api;

import dev.ams.cloud.reservationservice.data.ReservationEntity;
import dev.ams.cloud.reservationservice.data.ReservationRepository;
import dev.ams.cloud.reservationservice.error.BadReqeustException;
import dev.ams.cloud.reservationservice.error.NotFoundException;
...
public class ReservationController {
    ...
    public List<Reservation> getAll(@RequestParam(value = "guestId", required = false) Long guestId, @RequestParam(value = "date", required = false) String dateString) {
        log.info("getting all reservations for guestId {} and date {}", guestId, dateString);
        ...
        if (StringUtils.hasLength(dateString) && guestId != null) {
            try {
                ...
                log.error("unable to translate date", e);
    ...
    public Reservation getReservation(@PathVariable("id") long id) {
        log.info("getting details for reservation {}", id);
