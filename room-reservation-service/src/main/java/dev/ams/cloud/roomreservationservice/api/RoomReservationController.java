package dev.ams.cloud.roomreservationservice.api;

import dev.ams.cloud.roomreservationservice.client.guest.Guest;
import dev.ams.cloud.roomreservationservice.client.guest.GuestServiceClient;
import dev.ams.cloud.roomreservationservice.client.reservation.Reservation;
import dev.ams.cloud.roomreservationservice.client.reservation.ReservationServiceClient;
import dev.ams.cloud.roomreservationservice.client.room.Room;
import dev.ams.cloud.roomreservationservice.client.room.RoomServiceClient;
...
public class RoomReservationController {
    ...
    public Collection<RoomReservation> getRoomReservations(@RequestParam(value = "date", required = false) String dateString) {
        log.info("getting room reservations for date {}", dateString);
